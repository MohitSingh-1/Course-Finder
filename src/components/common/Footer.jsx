...
//   return (
//     <div className="h-[50vh] w-full bg-[#172131] flex flex-row justify-evenly">
//         {/* Upper div */}
//       <div className="CBI">
...
//        {/* Lower Div  */}
//       <div>
//         <div className="text-center">Made with ❤️ Mohit Singh © 2025 CourseFinder</div>
//       </div>
//     </div>
//   )
// }
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-gray-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-gray-700 pl-3 lg:pr-5 gap-3">
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div className="text-[14px] cursor-pointer hover:text-gray-50 transition-all duration-200 mt-2">
